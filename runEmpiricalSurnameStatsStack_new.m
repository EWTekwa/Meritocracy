...
NormType=1; %1 for global reference, 2 for US reference

%overwrite ratio data with chosen normalization:
HighIncomeUS=HighIncomeUS./[EntLRNorm(NormType) AdvRNorm(NormType) PubNorm(NormType)];
LowIncomeUS=LowIncomeUS./[EntLRNorm(NormType) AdvRNorm(NormType) PubNorm(NormType)];

HarvardEnvSci=HarvardEnvSci./[EntLRNorm(NormType) AdvRNorm(NormType) PubNorm(NormType)];
HarvardImmun=HarvardImmun./[EntLRNorm(NormType) AdvRNorm(NormType) PubNorm(NormType)];
HarvardSocio=HarvardSocio./[EntLRNorm(NormType) AdvRNorm(NormType) PubNorm(NormType)];
HarvardEvol=HarvardEvol./[EntLRNorm(NormType) AdvRNorm(NormType) PubNorm(NormType)];
HarvardEthni=HarvardEthni./[EntLRNorm(NormType) AdvRNorm(NormType) PubNorm(NormType)];
HarvardComSci=HarvardComSci./[EntLRNorm(NormType) AdvRNorm(NormType) PubNorm(NormType)];
